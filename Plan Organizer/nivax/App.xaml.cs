    ...
    sealed partial class App : Application
    {
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs args)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                StorageFile pwFile = await ApplicationData.Current.LocalFolder.CreateFileAsync("Passwords.txt", CreationCollisionOption.OpenIfExists);
                string text = await FileIO.ReadTextAsync(pwFile);
                ...
                {
                    rootFrame.Navigate(typeof(StartPage), list);
                }
            }
